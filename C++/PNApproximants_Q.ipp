...
private:
  ...
  const double m1, m2;
  double v;
  const Quaternion S_chi1, S_chi2;
...
public:
  TaylorTn_0PN_Q(const Quaternion xHat_i, const Quaternion yHat_i, const Quaternion zHat_i, const double m1_i, const double
           m2_i, const double v_i, const Quaternion S_chi1_i, const Quaternion S_chi2_i, const double rfrak_chi1_x_i,
           const double rfrak_chi1_y_i, const double rfrak_chi2_x_i, const double rfrak_chi2_y_i, const double
           rfrak_frame_x_i, const double rfrak_frame_y_i, const double rfrak_frame_z_i) :
    ...
    rfrak_frame_y*yHat + rfrak_frame_z*zHat)), nHat(R*xHat*conjugate(R)), ellHat(R*zHat*conjugate(R)), nHat_x(nHat[1]),
    nHat_y(nHat[2]), nHat_z(nHat[3]), ellHat_x(ellHat[1]), ellHat_y(ellHat[2]), ellHat_z(ellHat[3]),
    ...
    chi1_z(chiVec1[3]), chi2_x(chiVec2[1]), chi2_y(chiVec2[2]), chi2_z(chiVec2[3]), chi1chi1(pow(chi1_x, 2) +
    pow(chi1_y, 2) + pow(chi1_z, 2)), chi1chi2(chi1_x*chi2_x + chi1_y*chi2_y + chi1_z*chi2_z), chi2chi2(pow(chi2_x, 2) +
    pow(chi2_y, 2) + pow(chi2_z, 2)), chi1_ell(chi1_x*ellHat_x + chi1_y*ellHat_y + chi1_z*ellHat_z), chi1_n(chi1_x*nHat_x
    + chi1_y*nHat_y + chi1_z*nHat_z), chi2_ell(chi2_x*ellHat_x + chi2_y*ellHat_y + chi2_z*ellHat_z), chi2_n(chi2_x*nHat_x
    + chi2_y*nHat_y + chi2_z*nHat_z), S_ell(chi1_ell*pow(m1, 2) + chi2_ell*pow(m2, 2)), S_n(chi1_n*pow(m1, 2) + chi2_n*pow(m2,
    2)), Sigma_ell(m*(-chi1_ell*m1 + chi2_ell*m2)), Sigma_n(m*(-chi1_n*m1 + chi2_n*m2)), chi_s_ell(0.5*chi1_ell + 0.5*chi2_ell),
    chi_a_ell(0.5*chi1_ell - 0.5*chi2_ell), Fcal_coeff(6.4*pow(nu, 2)*pow(v, 10)), Fcal_0(1.00000000000000),
  ...
  Quaternion OrbitalAngularMomentum() {
    double L_coeff = pow(m, 2)*nu/v;
    Quaternion L_0 = ellHat;
    return L_0*L_coeff;
  }
...
public:
  ...
  Quaternion OrbitalAngularMomentum() {
    Quaternion L_2 = ellHat*(0.166666666666667*nu + 1.5);
    double L_coeff = pow(m, 2)*nu/v;
    Quaternion L_0 = ellHat;
...
public:
  TaylorTn_1p5PN_Q(const Quaternion xHat_i, const Quaternion yHat_i, const Quaternion zHat_i, const double m1_i, const double
    ...
    pow(chi1_y, 2) + pow(chi1_z, 2)), chi1chi2(chi1_x*chi2_x + chi1_y*chi2_y + chi1_z*chi2_z), chi2chi2(pow(chi2_x, 2) +
    pow(chi2_y, 2) + pow(chi2_z, 2)), chi1_ell(chi1_x*ellHat_x + chi1_y*ellHat_y + chi1_z*ellHat_z), chi1_n(chi1_x*nHat_x
    + chi1_y*nHat_y + chi1_z*nHat_z), chi1_lambda(chi1_x*lambdaHat_x + chi1_y*lambdaHat_y + chi1_z*lambdaHat_z),
    chi2_ell(chi2_x*ellHat_x + chi2_y*ellHat_y + chi2_z*ellHat_z), chi2_n(chi2_x*nHat_x + chi2_y*nHat_y + chi2_z*nHat_z),
    chi2_lambda(chi2_x*lambdaHat_x + chi2_y*lambdaHat_y + chi2_z*lambdaHat_z), S_ell(chi1_ell*pow(m1, 2) + chi2_ell*pow(m2, 2)),
    S_n(chi1_n*pow(m1, 2) + chi2_n*pow(m2, 2)), S_lambda(chi1_lambda*pow(m1, 2) + chi2_lambda*pow(m2, 2)), Sigma_ell(m*(-chi1_ell*m1 +
    chi2_ell*m2)), Sigma_n(m*(-chi1_n*m1 + chi2_n*m2)), Sigma_lambda(m*(-chi1_lambda*m1 + chi2_lambda*m2)), chi_s_ell(0.5*chi1_ell +
    0.5*chi2_ell), chi_a_ell(0.5*chi1_ell - 0.5*chi2_ell), Fcal_coeff(6.4*pow(nu, 2)*pow(v, 10)), Fcal_0(1.00000000000000),
    Fcal_2(-2.91666666666667*nu - 3.71130952380952), Fcal_3(12.5663706143592), Fcal_SO_3((-4.0*S_ell -
    1.25*Sigma_ell*delta)/pow(m, 2)), E_0(1.00000000000000), E_2(-0.0833333333333333*nu - 0.75),
  ...
  Quaternion OrbitalAngularMomentum() {
    ...
    double L_coeff = pow(m, 2)*nu/v;
    Quaternion L_0 = ellHat;
    Quaternion L_SO_3 = 0.166666666666667*ellHat*(-35.0*S_ell - 15.0*Sigma_ell*delta)/pow(m, 2) + lambdaHat*(-3.0*S_lambda -
      Sigma_lambda*delta)/pow(m, 2) + 0.5*nHat*(S_n + Sigma_n*delta)/pow(m, 2);
...
public:
  ...
  Quaternion OrbitalAngularMomentum() {
    Quaternion L_4 = ellHat*(0.0416666666666667*pow(nu, 2) - 2.375*nu + 3.375);
    double L_coeff = pow(m, 2)*nu/v;
    Quaternion L_SO_3 = 0.166666666666667*ellHat*(-35.0*S_ell - 15.0*Sigma_ell*delta)/pow(m, 2) + lambdaHat*(-3.0*S_lambda -
      Sigma_lambda*delta)/pow(m, 2) + 0.5*nHat*(S_n + Sigma_n*delta)/pow(m, 2);
    Quaternion L_2 = ellHat*(0.166666666666667*nu + 1.5);
...
public:
  ...
  Quaternion OrbitalAngularMomentum() {
    ...
    Quaternion L_2 = ellHat*(0.166666666666667*nu + 1.5);
    Quaternion L_0 = ellHat;
    Quaternion L_SO_5 = 0.0138888888888889*ellHat*(427.0*S_ell*nu - 693.0*S_ell + 210.0*Sigma_ell*delta*nu -
...
public:
  TaylorTn_3p0PN_Q(const Quaternion xHat_i, const Quaternion yHat_i, const Quaternion zHat_i, const double m1_i, const double
    ...
    S_n(chi1_n*pow(m1, 2) + chi2_n*pow(m2, 2)), S_lambda(chi1_lambda*pow(m1, 2) + chi2_lambda*pow(m2, 2)), Sigma_ell(m*(-chi1_ell*m1 +
    chi2_ell*m2)), Sigma_n(m*(-chi1_n*m1 + chi2_n*m2)), Sigma_lambda(m*(-chi1_lambda*m1 + chi2_lambda*m2)), chi_s_ell(0.5*chi1_ell +
    0.5*chi2_ell), chi_a_ell(0.5*chi1_ell - 0.5*chi2_ell), logv(log(v)), Fcal_coeff(6.4*pow(nu, 2)*pow(v, 10)),
  ...
  Quaternion OrbitalAngularMomentum() {
    Quaternion L_4 = ellHat*(0.0416666666666667*pow(nu, 2) - 2.375*nu + 3.375);
    double L_coeff = pow(m, 2)*nu/v;
    Quaternion L_6 = ellHat*(0.00540123456790123*pow(nu, 3) + 1.29166666666667*pow(nu, 2) - 30.9797035925835*nu +
      8.4375);
    Quaternion L_SO_3 = 0.166666666666667*ellHat*(-35.0*S_ell - 15.0*Sigma_ell*delta)/pow(m, 2) + lambdaHat*(-3.0*S_lambda -
      Sigma_lambda*delta)/pow(m, 2) + 0.5*nHat*(S_n + Sigma_n*delta)/pow(m, 2);
    Quaternion L_2 = ellHat*(0.166666666666667*nu + 1.5);
...
public:
  ...
  Quaternion OrbitalAngularMomentum() {
    Quaternion L_4 = ellHat*(0.0416666666666667*pow(nu, 2) - 2.375*nu + 3.375);
    double L_coeff = pow(m, 2)*nu/v;
    Quaternion L_SO_7 = 0.0625*ellHat*(-29.0*S_ell*pow(nu, 2) + 1101.0*S_ell*nu - 405.0*S_ell - 15.0*Sigma_ell*delta*pow(nu, 2)
      + 468.0*Sigma_ell*delta*nu - 81.0*Sigma_ell*delta)/pow(m, 2) + 0.0416666666666667*lambdaHat*(-32.0*S_lambda*pow(nu, 2) +
      2.0*S_lambda*nu - 174.0*S_lambda - 16.0*Sigma_lambda*delta*pow(nu, 2) - 79.0*Sigma_lambda*delta*nu - 12.0*Sigma_lambda*delta)/pow(m,
      2) + 0.0208333333333333*nHat*(11.0*S_n*pow(nu, 2) - 1331.0*S_n*nu + 183.0*S_n + 5.0*Sigma_n*delta*pow(nu, 2) -
...
public:
  TaylorTn_4p0PN_Q(const Quaternion xHat_i, const Quaternion yHat_i, const Quaternion zHat_i, const double m1_i, const double
    ...
    + Sigma_ell*delta*(1.25*pow(nu, 2) - 39.0*nu + 6.75))/pow(m, 2)),
    Phi(0.0), EvolveSpin1(S_chi1.normsquared()>1e-12), EvolveSpin2(S_chi2.normsquared()>1e-12)
  { }
  ...
  Quaternion OrbitalAngularMomentum() {
    ...
    Quaternion L_SO_7 = 0.0625*ellHat*(-29.0*S_ell*pow(nu, 2) + 1101.0*S_ell*nu - 405.0*S_ell - 15.0*Sigma_ell*delta*pow(nu, 2)
      ...
      2) + 0.0208333333333333*nHat*(11.0*S_n*pow(nu, 2) - 1331.0*S_n*nu + 183.0*S_n + 5.0*Sigma_n*delta*pow(nu, 2) -
      734.0*Sigma_n*delta*nu + 183.0*Sigma_n*delta)/pow(m, 2);
    Quaternion L_8 = ellHat*(-0.714285714285714*nu*(0.0024755658436214*pow(nu, 3) + 0.174189814814815*pow(nu, 2) -
      90.1327990262052*nu + 153.88379682994) + 1.82857142857143*nu + 22.1484375);
    Quaternion L_6 = ellHat*(0.00540123456790123*pow(nu, 3) + 1.29166666666667*pow(nu, 2) - 30.9797035925835*nu +
      8.4375);
    Quaternion L_SO_3 = 0.166666666666667*ellHat*(-35.0*S_ell - 15.0*Sigma_ell*delta)/pow(m, 2) + lambdaHat*(-3.0*S_lambda -
      Sigma_lambda*delta)/pow(m, 2) + 0.5*nHat*(S_n + Sigma_n*delta)/pow(m, 2);
    Quaternion L_2 = ellHat*(0.166666666666667*nu + 1.5);
    Quaternion L_0 = ellHat;
    Quaternion L_lnv_8 = -42.6666666666667*ellHat*nu;
    Quaternion L_SO_5 = 0.0138888888888889*ellHat*(427.0*S_ell*nu - 693.0*S_ell + 210.0*Sigma_ell*delta*nu -
      189.0*Sigma_ell*delta)/pow(m, 2) + 0.166666666666667*lambdaHat*(18.0*S_lambda*nu - 21.0*S_lambda + 8.0*Sigma_lambda*delta*nu -
      3.0*Sigma_lambda*delta)/pow(m, 2) + 0.0416666666666667*nHat*(-19.0*S_n*nu + 33.0*S_n - 10.0*Sigma_n*delta*nu +
      33.0*Sigma_n*delta)/pow(m, 2);
...
public:
  ...
  Quaternion OrbitalAngularMomentum() {
    ...
    Quaternion L_0 = ellHat;
    Quaternion L_lnv_8 = -42.6666666666667*ellHat*nu;
    Quaternion L_lnv_10 = 2.0*ellHat*nu*(87.4666666666667*nu + 95.0095238095238);
    Quaternion L_SO_5 = 0.0138888888888889*ellHat*(427.0*S_ell*nu - 693.0*S_ell + 210.0*Sigma_ell*delta*nu -
      189.0*Sigma_ell*delta)/pow(m, 2) + 0.166666666666667*lambdaHat*(18.0*S_lambda*nu - 21.0*S_lambda + 8.0*Sigma_lambda*delta*nu -
      3.0*Sigma_lambda*delta)/pow(m, 2) + 0.0416666666666667*nHat*(-19.0*S_n*nu + 33.0*S_n - 10.0*Sigma_n*delta*nu +
      33.0*Sigma_n*delta)/pow(m, 2);
    Quaternion L_10 = ellHat*(nu*(-4.85925925925926*nu - 5.27830687830688) + 59.80078125);
