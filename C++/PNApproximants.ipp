...
public:
  TaylorTn_0PN(const double m1_i, const double m2_i, const double v_i, const double chi1_x_i, const double chi1_y_i,
    ...
    0.5*chi2_l), Fcal_coeff(6.4*pow(nu, 2)*pow(v, 10)), Fcal_0(1.00000000000000), E_0(1.00000000000000), Phi(0.0), gamma(0.0)
  {
    ellHat[0] = ellHat_x;
    ellHat[1] = ellHat_y;
    ellHat[2] = ellHat_z;
...
public:
  TaylorTn_2p0PN(const double m1_i, const double m2_i, const double v_i, const double chi1_x_i, const double chi1_y_i,
    ...
    2.0*Sigma_l*delta)/pow(m, 2)), Phi(0.0), gamma(0.0)
  {
    ellHat[0] = ellHat_x;
    ellHat[1] = ellHat_y;
    ellHat[2] = ellHat_z;
...
public:
  TaylorTn_4p0PN(const double m1_i, const double m2_i, const double v_i, const double chi1_x_i, const double chi1_y_i,
    ...
    + Sigma_l*delta*(1.25*pow(nu, 2) - 39.0*nu + 6.75))/pow(m, 2)), Phi(0.0), gamma(0.0)
  {
    ellHat[0] = ellHat_x;
    ellHat[1] = ellHat_y;
    ellHat[2] = ellHat_z;
...
public:
  TaylorTn_5p0PN(const double m1_i, const double m2_i, const double v_i, const double chi1_x_i, const double chi1_y_i,
    ...
    285.028571428571)), E_SQ_4(-1.5*pow(chi_a_l, 2) - 1.5*pow(chi_s_l, 2) - delta*(0.5*chi2chi2 + 3.0*chi_a_l*chi_s_l) +
    nu*(chi1chi2 + 6.0*pow(chi_a_l, 2)) + 0.25*(chi1chi1 + chi2chi2)*(delta - 2.0*nu + 1.0)),
    E_SO_3((4.66666666666667*S_l + 2.0*Sigma_l*delta)/pow(m, 2)), E_SO_5((S_l*(-6.77777777777778*nu + 11.0) +
    Sigma_l*delta*(-3.33333333333333*nu + 3.0))/pow(m, 2)), E_SO_7((S_l*(2.41666666666667*pow(nu, 2) - 91.75*nu + 33.75)
    + Sigma_l*delta*(1.25*pow(nu, 2) - 39.0*nu + 6.75))/pow(m, 2)), Phi(0.0), gamma(0.0)
...
public:
  ...
  int TaylorT4(double t, const double* y, double* dydt) {
    ...
    const double dvdt_T4 = -2.0*Fcal_coeff*(pow(v, 2)*(v*(v*(v*(v*(v*(v*(v*(v*(v*((-0.5*Fcal_11 -
      0.5*Fcal_lnv_11*logv)/m + ((E_2*(1.0*Fcal_9 + 1.0*Fcal_lnv_9*logv) + E_4*(1.5*Fcal_7 + 1.5*Fcal_SO_7) +
      E_6*(2.0*Fcal_5 + 2.0*Fcal_SO_5) + E_8*(2.5*Fcal_3 + 2.5*Fcal_SO_3) + E_SO_3*(1.25*Fcal_8 + 1.25*Fcal_SO_8 +
      1.25*Fcal_lnv_8*logv) + E_SO_5*(1.75*Fcal_6 + 1.75*Fcal_SO_6 + 1.75*Fcal_lnv_6*logv) + E_SO_7*(2.25*Fcal_4 +
      2.25*Fcal_SQ_4) + E_SQ_4*(1.5*Fcal_7 + 1.5*Fcal_SO_7) + E_lnv_8*(Fcal_3*(2.5*logv + 0.25) + Fcal_SO_3*(2.5*logv +
      0.25)))/m + ((E_2*(E_2*(-2.0*Fcal_7 - 2.0*Fcal_SO_7) + E_4*(-6.0*Fcal_5 - 6.0*Fcal_SO_5) + E_6*(-8.0*Fcal_3 -
  ...
  int TaylorT5(double t, const double* y, double* dydt) {
    Recalculate(t, y);
    if(v>=1.0) { return GSL_EDOM; } // Beyond domain of PN validity
    const double dtdv = -0.5*nu*v*(-2.0*E_0*m/Fcal_0 + pow(v, 2)*(v*(v*(v*(v*(v*(v*(v*(v*(m*(-12.0*E_10 +
      E_lnv_10*(-12.0*logv - 1.0) + (E_0*(2.0*Fcal_10 + 2.0*Fcal_lnv_10*logv) + E_2*(4.0*Fcal_8 + 4.0*Fcal_SO_8 +
      4.0*Fcal_lnv_8*logv) + E_4*(6.0*Fcal_6 + 6.0*Fcal_SO_6 + 6.0*Fcal_lnv_6*logv) + E_6*(8.0*Fcal_4 + 8.0*Fcal_SQ_4) +
      10.0*E_8*Fcal_2 + E_SO_3*(5.0*Fcal_7 + 5.0*Fcal_SO_7) + E_SO_5*(7.0*Fcal_5 + 7.0*Fcal_SO_5) + E_SO_7*(9.0*Fcal_3 +
      9.0*Fcal_SO_3) + E_SQ_4*(6.0*Fcal_6 + 6.0*Fcal_SO_6 + 6.0*Fcal_lnv_6*logv) + E_lnv_8*Fcal_2*(10.0*logv + 1.0) +
      ...
      2)*(Fcal_2*(-8.0*Fcal_4 - 8.0*Fcal_SQ_4) + Fcal_3*(-12.0*Fcal_3 - 24.0*Fcal_SO_3) - 12.0*pow(Fcal_SO_3, 2)) +
      2.0*E_0*pow(Fcal_2, 5)/Fcal_0 - 4.0*E_2*pow(Fcal_2, 4))/Fcal_0)/Fcal_0)/Fcal_0)/Fcal_0)/Fcal_0 +
      m*v*(E_0*(2.0*Fcal_11 + 2.0*Fcal_lnv_11*logv) + E_2*(4.0*Fcal_9 + 4.0*Fcal_lnv_9*logv) + E_4*(6.0*Fcal_7 +
      ...
      5.0*E_SO_3*pow(Fcal_2, 4))/Fcal_0)/Fcal_0)/Fcal_0)/pow(Fcal_0, 2)) + m*(E_0*(2.0*Fcal_9 + 2.0*Fcal_lnv_9*logv) +
      E_2*(4.0*Fcal_7 + 4.0*Fcal_SO_7) + E_4*(6.0*Fcal_5 + 6.0*Fcal_SO_5) + E_6*(8.0*Fcal_3 + 8.0*Fcal_SO_3) +
      E_SO_3*(5.0*Fcal_6 + 5.0*Fcal_SO_6 + 5.0*Fcal_lnv_6*logv) + E_SO_5*(7.0*Fcal_4 + 7.0*Fcal_SQ_4) +
      9.0*E_SO_7*Fcal_2 + E_SQ_4*(6.0*Fcal_5 + 6.0*Fcal_SO_5) + (E_0*(Fcal_2*(-4.0*Fcal_7 - 4.0*Fcal_SO_7) +
      Fcal_3*(-4.0*Fcal_6 - 4.0*Fcal_SO_6 - 4.0*Fcal_lnv_6*logv) + Fcal_4*(-4.0*Fcal_5 - 4.0*Fcal_SO_5) -
...
public:
  TaylorTn_6p0PN(const double m1_i, const double m2_i, const double v_i, const double chi1_x_i, const double chi1_y_i,
    ...
    E_8(0.0024755658436214*pow(nu, 4) + 0.174189814814815*pow(nu, 3) - 90.1327990262052*pow(nu, 2) + 153.8803*nu -
    31.0078125), E_lnv_8(59.7333333333333*nu), E_10(-55.13*nu - 89.701171875), E_lnv_10(nu*(-253.866666666667*nu -
    285.028571428571)), E_12(588.0*nu - 258.4248046875), E_lnv_12(-2288.0*nu), E_SQ_4(-1.5*pow(chi_a_l, 2) -
  ...
  int TaylorT5(double t, const double* y, double* dydt) {
    ...
    const double dtdv = -0.5*nu*v*(-2.0*E_0*m/Fcal_0 + pow(v, 2)*(v*(v*(v*(v*(v*(v*(v*(v*(v*(m*v*(-14.0*E_12 +
      ...
      4.0*E_2*pow(Fcal_2, 5))/Fcal_0)/Fcal_0)/Fcal_0)/Fcal_0)/Fcal_0)/Fcal_0 + m*(E_0*(2.0*Fcal_11 +
      ...
      Fcal_3*(Fcal_3*(-8.0*Fcal_3 - 24.0*Fcal_SO_3) - 24.0*pow(Fcal_SO_3, 2)) - 8.0*pow(Fcal_SO_3, 3)) + E_0*pow(Fcal_2,
      4)*(10.0*Fcal_3 + 10.0*Fcal_SO_3)/Fcal_0 + E_2*pow(Fcal_2, 3)*(-16.0*Fcal_3 - 16.0*Fcal_SO_3) -
      5.0*E_SO_3*pow(Fcal_2, 4))/Fcal_0)/Fcal_0)/Fcal_0)/pow(Fcal_0, 2)) + m*(-12.0*E_10 + E_lnv_10*(-12.0*logv - 1.0) +
