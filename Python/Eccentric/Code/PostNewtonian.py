...
def PNWaveform(q,M,omega_0,chi1_0,chi2_0,e_0=0.0,xi_0=0.0,frame_0=quaternion.quaternion(1.0,0.0,0.0,0.0),t_0=0.0, t_PNStart=False, t_PNEnd=False, datatype="h", return_chi=False, PNEvolutionOrder=4.0, PNWaveformModeOrder=3.5, TaylorTn=1, StepsPerOrbit=32, ForwardInTime=True, tol=1e-10, MinStep=1e-7):
    """
    ...
    frame_0: the frame quaternion at t_0, quaternion object,
    ...
    PN=PNEvolution.PNEv.Evolution(wHat, xHat, yHat, zHat, m1, m2, e_0, xi_0, v_0, S_chi1_0, S_chi2_0, quaternion.as_float_array(frame_0), t_PNStart, t_PNEnd,
